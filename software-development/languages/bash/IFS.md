...
- the default value for `IFS` is _space_, *tab*, *newline*, which it defaults to if it is unset, too
...
- `IFS` is _only_ used in word splitting of **data**, _not_ lines of script. Lines of script are always split by whitespace
