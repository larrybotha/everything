...
- the author suggest different stages to summarisation, spread out over time:
	...
	1. Layer 2: bolding important bits from Layer 1 that describe the core essence of the topic
	2. Layer 3: highlighting the most important aspects within the bolded text
	3. Layer 4: add an executive summary at the top of the document in their own words
	4. Layer 5: if the content makes sense to do so with, create something new - blog post, video, sketching, tweeting etc.
